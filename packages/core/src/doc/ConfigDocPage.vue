...
const baseTableComponent = "BaseTable";

// --- 配置 JSON 预览 ---
const configJson = computed(() => JSON.stringify({ theme: { ...themeForm } }, null, 2));

// --- 应用并持久化 ---
const saved = ref(false);
function handleSave() {
  lib.saveConfig({ theme: { ...themeForm } });
  saved.value = true;
  setTimeout(() => {
    saved.value = false;
  }, 2000);
...
// --- 预设方案 ---
function applyPreset(preset: Partial<typeof themeForm>) {
  ...
  <div class="demo-config">
    ...
    <div class="demo-config__layout">
      ...
      <aside class="demo-config__panel">
        ...
        <p class="demo-config__note">
          Table 布局参数已由 BaseTable 组件内部维护，此处仅保留主题配置同步。
        </p>
      </aside>

      <!-- 右侧预览区域 -->
      <section class="demo-config__main">
        <ConfigProvider :theme="{ ...themeForm }">
          <div class="demo-config__preview" :style="{ background: themeForm.bgPage }">
            ...
            >
              <h4 :style="{ color: themeForm.textHeading }">表格风格预览</h4>
              <div class="demo-config__table-wrap demo-config__table-wrap--base-table">
                <component
                  :is="baseTableComponent"
                  mode="element"
            ...
            >
              ...
              <div class="demo-config__btn-row">
                <span
                  ...
                  :style="{
                    background: themeForm.colorPrimary,
                ...
                <span
                  ...
                  :style="{
                    background: themeForm.colorPrimary + '1a',
                    color: themeForm.colorPrimary,
                    borderRadius: themeForm.radiusSm + 'px',
                  }"
                >
                ...
                <span
                  class="demo-config__tag"
                  :style="{
                    background: themeForm.colorSuccess + '1a',
                    color: themeForm.colorSuccess,
                    borderRadius: themeForm.radiusSm + 'px',
                  }"
                >
                  标签 B
                ...
                <span
                  class="demo-config__tag"
                  :style="{
                    background: themeForm.colorWarning + '1a',
                    color: themeForm.colorWarning,
                    borderRadius: themeForm.radiusSm + 'px',
                  }"
                >
                  标签 C
            ...
            <div
              ...
              :style="{ background: themeForm.bgCard, borderColor: themeForm.borderColor }"
            >
              <h4 :style="{ color: themeForm.textHeading }">状态点预览</h4>
              <div class="demo-config__dots">
                <span class="demo-config__dot-item">
                  <i class="demo-config__dot" :style="{ background: themeForm.colorSuccess }" />
                  在线
                </span>
                <span class="demo-config__dot-item">
                  <i class="demo-config__dot" :style="{ background: themeForm.textSecondary }" />
                  离线
                </span>
                <span class="demo-config__dot-item">
                  <i class="demo-config__dot" :style="{ background: themeForm.colorWarning }" />
                  忙碌
                </span>
                <span class="demo-config__dot-item">
                  <i class="demo-config__dot" :style="{ background: themeForm.colorPrimary }" />
                  会议中
                </span>
              </div>
            </div>
...
.demo-config__table-wrap {
  overflow: auto;
}

.demo-config__table-wrap--base-table {
  border: 1px solid $doc-border-color;
  border-radius: $doc-radius-md;
  overflow: hidden;
  background: $doc-bg-card;
