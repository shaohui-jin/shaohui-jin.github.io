        ...
        <ConfigProvider :theme="{ ...themeForm }" :table="{ ...tableForm }">
          <div class="demo-config__preview" :style="{ background: themeForm.bgPage }">
            ...
            <div
              ...
              :style="{ background: themeForm.bgCard, borderColor: themeForm.borderColor }"
            >
              <h4 :style="{ color: themeForm.textHeading }">Dot 组件</h4>
              <div class="demo-config__dots">
                <Dot :color="themeForm.colorSuccess" text="在线" />
                <Dot :color="themeForm.textSecondary" text="离线" />
                <Dot :color="themeForm.colorWarning" text="忙碌" />
                <Dot :color="themeForm.colorPrimary" text="会议中" />
                <Dot text="默认" />
              </div>
            </div>
