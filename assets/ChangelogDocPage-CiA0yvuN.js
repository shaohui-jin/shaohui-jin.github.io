import{d as P,b as o,e as t,F as p,r as h,m as w,o as a,T,t as u,f as E,w as L,a3 as A,a4 as I,a2 as k,k as H,h as y,a5 as V,i as G,_ as M}from"./index-CcjRng07.js";const N=`# 版本变更记录
...
`,R={class:"cl"},W={class:"cl__list"},z=["onClick"],F={class:"cl__ver-tag"},O={class:"cl__ver-date"},U={class:"cl__body"},q={class:"cl__mod-name"},J={key:0,class:"cl__grp-type"},$={class:"cl__items"},K={class:"cl__item-content"},Q={key:0,class:"cl__tag"},X=P({__name:"ChangelogDocPage",setup(Y){function _(s){return s.includes("新增")?"#10b981":s.includes("调整")||s.includes("修改")?"#4366f1":s.includes("修复")?"#f59e0b":s.includes("移除")||s.includes("删除")?"#ef4444":"#94a3b8"}function B(s){const g=[],r=s.split(`
`);let i=null,n=null,e=null;for(const l of r){const m=l.match(/^## (v[\d.]+)(?:[（(](.+?)[）)])?/);if(m){i={version:m[1],date:m[2]??"",modules:[]},g.push(i),n=null,e=null;continue}if(!i)continue;const b=l.match(/^### (.+)/);if(b){n={name:b[1],groups:[]},i.modules.push(n),e=null;continue}const f=l.match(/^#### (.+)/);if(f&&n){e={type:f[1],items:[]},n.groups.push(e);continue}const v=l.match(/^- \*\*(.+?)\*\*[：:](.+)/);if(v){const c={label:v[1],text:v[2].trim()};e?e.items.push(c):n&&(n.groups.length||n.groups.push({type:"",items:[]}),n.groups[n.groups.length-1].items.push(c));continue}const C=l.match(/^- (.+)/);if(C&&!C[1].startsWith("*")){const c={label:"",text:C[1].trim()};e?e.items.push(c):n&&(n.groups.length||n.groups.push({type:"",items:[]}),n.groups[n.groups.length-1].items.push(c));continue}const S=l.match(/^\s+- (.+)/);if(S){const c=e??(n==null?void 0:n.groups[n.groups.length-1]);if(c&&c.items.length>0){const j=c.items[c.items.length-1];j.text+=`；${S[1].trim()}`}}}return g}const D=w(()=>B(N)),d=G(0);function x(s){d.value=d.value===s?-1:s}return(s,g)=>(a(),o("div",R,[t("div",W,[(a(!0),o(p,null,h(D.value,(r,i)=>(a(),o("div",{key:r.version,class:"cl__ver"},[t("div",{class:"cl__ver-head",onClick:n=>x(i)},[t("span",{class:T(["cl__dot",{"is-latest":i===0}])},null,2),t("span",F,u(r.version),1),t("span",O,u(r.date),1),t("span",{class:T(["cl__arrow",{"is-open":d.value===i}])},null,2)],8,z),E(V,{name:"cl-expand"},{default:L(()=>[A(t("div",U,[(a(!0),o(p,null,h(r.modules,n=>(a(),o("div",{key:n.name,class:"cl__mod"},[t("div",q,u(n.name),1),(a(!0),o(p,null,h(n.groups,e=>(a(),o(p,{key:e.type},[e.type?(a(),o("div",J,[t("span",{class:"cl__grp-dot",style:k({background:_(e.type)})},null,4),H(" "+u(e.type),1)])):y("",!0),t("div",$,[(a(!0),o(p,null,h(e.items,(l,m)=>(a(),o("div",{key:m,class:"cl__item"},[t("span",{class:"cl__item-bullet",style:k({background:_(e.type)})},null,4),t("div",K,[l.label?(a(),o("code",Q,u(l.label),1)):y("",!0),t("span",null,u(l.text),1)])]))),128))])],64))),128))]))),128))],512),[[I,d.value===i]])]),_:2},1024)]))),128))])]))}}),nn=M(X,[["__scopeId","data-v-46450dcb"]]);export{nn as default};
