const e={baseSearch:`<script setup lang="ts">
import { ref } from "vue";
...
<template>
  <BaseSearch
    ...
    @change="onChange"
  />
</template>`,baseSearchField:`<script setup lang="ts">
import { ref } from "vue";
...
</template>`,baseSearchDrawer:`<script setup lang="ts">
import { ref } from "vue";
...
</template>`,baseColumnSetting:`<script setup lang="ts">
...
</template>`,baseCrud:`<script setup lang="ts">
import { ref } from "vue";
import {
  BaseCrud,
...
<template>
  ...
  />
</template>`,tag:`<script setup lang="ts">
...
</template>`,dotBasic:`<script setup lang="ts">
...
</template>`,dotSlot:`<script setup lang="ts">
import { Dot } from "jsh-comp";
<\/script>
...
</template>`,image3d:`<script setup lang="ts">
import { Image3D } from "jsh-comp";
<\/script>

<template>
  <Image3D src="https://picsum.photos/seed/lib-img/300/200" />
</template>`,imageCarousel:`<script setup lang="ts">
import { ref } from "vue";
...
<template>
  <ImageCarousel
    ...
    @change="onChange"
  />
</template>`,imagePointer:`<script setup lang="ts">
...
<template>
  <ImagePointer
    ...
    @leave="onLeave"
  />
</template>`,canvasTime:`<script setup lang="ts">
import { CanvasTime } from "jsh-comp";
<\/script>

<template>
  <CanvasTime color="#333333" bg-color="#f9f9fb" />
</template>`,codeBlock:`<script setup lang="ts">
...
</template>`,widgetTabs:`<script setup lang="ts">
import { computed } from "vue";
...
</template>`,splitPane:`<script setup lang="ts">
import { ref } from "vue";
...
</template>`,dragSortList:`<script setup lang="ts">
import { ref } from "vue";
...
</template>`,floatingToolbar:`<script setup lang="ts">
...
</template>`,treeTransfer:`<script setup lang="ts">
import { ref } from "vue";
...
</template>`,stepWizard:`<script setup lang="ts">
import { ref } from "vue";
...
</template>`,contextMenu:`<script setup lang="ts">
...
</template>`,canvasCountUp:`<script setup lang="ts">
import { ref } from "vue";
...
</template>`,heatmapCalendar:`<script setup lang="ts">
...
</template>`,imageLightbox:`<script setup lang="ts">
import { ref } from "vue";
